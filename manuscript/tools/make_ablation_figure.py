...
plt.tight_layout()
plt.savefig("manuscript/icaiet2027/figures/fig_ablation.pdf", bbox_inches="tight")
plt.savefig("manuscript/icaiet2027/figures/fig_ablation.png", dpi=150, bbox_inches="tight")
